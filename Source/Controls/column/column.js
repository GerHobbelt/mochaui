...
MUI.Column = new NamedClass('MUI.Column', {
	...
	options: {
		...
		sortable:		true,
		isCollapsed:	false,
		keep1PanelOpen:	false,		// TRUE: at least one panel in this column is forced to remain expanded; FALSE: no panel in this column is kept in an expended state when all the others are collapsed.
...
if (window.MUI && window.MUI.files) { MUI.files['{controls}column/column.js'] = 'loaded'; }
